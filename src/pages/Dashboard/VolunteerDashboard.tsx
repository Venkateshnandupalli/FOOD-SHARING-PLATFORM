              ...
              <Card key={d.match_id} className="p-5 flex flex-col hover:border-gray-300 transition-colors">
                ...
                <div className="space-y-4 mb-6 flex-1">
                  <div className="flex gap-3 items-start">
                    <div className="mt-1 bg-gray-100 p-1.5 rounded-full text-gray-500">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600 line-clamp-1">{d.donor_address}</p>
                    </div>
                  </div>
                  
                  <div className="w-0.5 h-6 bg-gray-200 ml-3.5 -my-2"></div>
                  
                  <div className="flex gap-3 items-start">
                    <div className="mt-1 bg-[hsl(142,60%,94%)] p-1.5 rounded-full text-[hsl(142,71%,28%)]">
                      <MapPin className="w-4 h-4" />
                    </div>
                    <div>
                      <p className="text-xs font-semibold text-[hsl(142,71%,28%)] uppercase tracking-wide">Drop-off</p>
                      <p className="text-sm font-medium text-gray-900">{d.recipient_name}</p>
                      <p className="text-sm text-gray-600 line-clamp-1">{d.recipient_address}</p>
                    </div>
                  </div>
                </div>
                ...
                <Card key={del.id} className={`p-5 flex flex-col ${isCompleted ? 'opacity-70 bg-gray-50' : ''}`}>
                  ...
                  <div className="space-y-4 mb-6 flex-1">
                    <div className="flex gap-3 items-start">
                      ...
                      <div>
                        <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide">Pickup</p>
                        <p className="text-sm text-gray-600 line-clamp-2">{d.address}</p>
                      </div>
                    </div>
                  ...
                  {!isCompleted && (
                    ...
                    >
                      ...
                      {del.status === 'EN_ROUTE_DELIVERY' && 'Mark as Delivered'}
